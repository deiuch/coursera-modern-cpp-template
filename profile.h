#ifndef COURSERA_MODERN_CPP_PROFILE_H_
#define COURSERA_MODERN_CPP_PROFILE_H_
...
class LogDuration {
 public:
  inline explicit LogDuration(const std::string& msg = "")
...
#endif  // COURSERA_MODERN_CPP_PROFILE_H_
